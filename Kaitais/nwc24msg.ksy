...
seq:
  ...
  - id: title_booting
    type: u4
    doc: Normally set to zero when Wii Menu creates this config file. Enables WC24 title booting when non-zero. KD can't change this field since the function that sets it isn't used, and Wii Menu doesn't change this.
  - id: checksum
    type: u4
